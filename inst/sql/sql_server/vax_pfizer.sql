...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (37003436,35891709,35895097,35891603,766231,35895192,766238,42796343,35891484,35891695,1219271,42797615,37003431,37003433,42797616,766232)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (37003436,35891709,35895097,35891603,766231,35895192,766238,42796343,35891484,35891695,1219271,42797615,37003431,37003433,42797616,766232)
...
JOIN #Codesets codesets on ((de.drug_source_concept_id = codesets.concept_id and codesets.codeset_id = 4))
) C
