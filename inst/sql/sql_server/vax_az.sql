...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1230962,724905,766236,766237,766240,35891522,35895099,35891864,35895100,35891906,1227568,35891649,35895193,35891890,35895194,35891433)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1230962,724905,766236,766237,766240,35891522,35895099,35891864,35895100,35891906,1227568,35891649,35895193,35891890,35895194,35891433)
...
JOIN #Codesets codesets on ((de.drug_source_concept_id = codesets.concept_id and codesets.codeset_id = 5))
) C
