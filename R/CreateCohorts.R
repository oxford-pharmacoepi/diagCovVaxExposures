...
.createCohorts <- function(connection,
  ...
  pathToCsv <- system.file("cohorts", "InclusionRules.csv", package = "diagCovVaxExposures")
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "diagCovVaxExposures")
  checkInputFileEncoding(pathToCsv)
  ...
  for (i in 1:nrow(cohortsToCreate)) {
    ...
    sql <- SqlRender::loadRenderTranslateSql(sqlFilename = paste0(cohortsToCreate$name[i], ".sql"),
                                             ...
                                             results_database_schema.cohort_censor_stats = "#cohort_censor_stats",         ##### 20210901 added XL ############# 
  ...
  fetchStats("cohort_censor_stats")   ##### 20210901 added XL ############# 
